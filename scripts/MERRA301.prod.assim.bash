...
get MERRA301.prod.assim.tavg3_2d_chm_Fx.$date.hdf

cd /data/s4pa/MERRA/MAI3NECHM.5.2.0/$year/$month
get MERRA301.prod.assim.inst3_3d_chm_Ne.$date.hdf

cd /data/s4pa/MERRA/MAT3FECHM.5.2.0/$year/$month
get MERRA301.prod.assim.tavg3_3d_chm_Fe.$date.hdf

cd /data/s4pa/MERRA/MAT3FVCHM.5.2.0/$year/$month
get MERRA301.prod.assim.tavg3_3d_chm_Fv.$date.hdf

cd /data/s4pa/MERRA/MAT3NECHM.5.2.0/$year/$month
get MERRA301.prod.assim.tavg3_3d_chm_Ne.$date.hdf
...
get MERRA301.prod.assim.tavg1_2d_flx_Nx.$date.hdf

cd /data/s4pa/MERRA/MAT1NXLND.5.2.0/$year/$month
get MERRA301.prod.assim.tavg1_2d_lnd_Nx.$date.hdf

cd /data/s4pa/MERRA/MAT1NXSLV.5.2.0/$year/$month
get MERRA301.prod.assim.tavg1_2d_slv_Nx.$date.hdf
...
get MERRA301.prod.assim.inst6_3d_ana_Nv.$date.hdf
